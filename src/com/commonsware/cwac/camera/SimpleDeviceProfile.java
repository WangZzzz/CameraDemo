...
public class SimpleDeviceProfile extends DeviceProfile {
	...
	SimpleDeviceProfile load(XmlPullParser xpp) {
		...
		try {
			...
			Log.e("CWAC-Camera", String.format(
					"Exception parsing device profile for %s %s",
	...
	private boolean isCyanogenMod() {
		return (System.getProperty("os.version").contains("cyanogenmod") || Build.HOST
				.contains("cyanogenmod"));
	}
